    ...
    <div className={classes.footer}>
      <div className={`${classes.footer__up} row`}>
        ...
        <div className="col-6 col-md-4 footer__company d-none d-lg-block d-xl-block">
          ...
          <div>
            <div className={classes.company__logo}>
              ...
              >
                <img
                  src="/img/logo-connect/galaxycine.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
              ...
              >
                <img
                  src="/img/logo-connect/cinestar.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
              ...
              >
                <img
                  src="/img/logo-connect/lotte.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
            ...
            <div className={classes.company__logo}>
              ...
              >
                <img
                  src="/img/logo-connect/megags.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
              ...
              >
                <img
                  src="/img/logo-connect/dongdacinema.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
              ...
              >
                <img
                  src="/img/logo-connect/TOUCH.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
            ...
            <div className={classes.company__logo}>
              ...
              >
                <img
                  src="/img/logo-connect/AGRIBANK.png"
                  alt=""
                  className={classes.logo}
                />
              </a>
        ...
        <div className="col-6 col-md-4 d-flex text-center">
          <div
            className={`${classes.social__width} d-none d-lg-block d-xl-block`}
          >
            ...
            <div className="footer__mobile d-flex justify-content-around">
              ...
              >
                <img
                  className={classes.logo}
                  src="/img/mobile-system/apple-logo.png"
                  alt=""
                />
              </a>
              <a
              ...
              >
                <img
                  className={classes.logo}
                  src="/img/mobile-system/android-logo.png"
                  alt=""
                />
              </a>
            </div>
      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          <div className="col-12 col-md-1 p-1 text-center">
            <img
              src="/img/logo-connect/zion-logo.jpg"
              alt="company"
